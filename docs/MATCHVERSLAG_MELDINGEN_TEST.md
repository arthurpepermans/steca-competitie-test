...
Update: wedstrijdminuten worden niet meer getoond of ingevoerd. De gebeurtenissen staan in invoervolgorde, met goal- en kaarticonen. Het testcentrum heeft nu een lege wedstrijd van 81 minuten geleden om zelf in te vullen. Bij verwijderen wordt eerst op de server gecontroleerd of de huidige gebruiker de aangewezen testbeheerder is en de wedstrijd een toegestane testbron heeft. Daarna worden alleen de beelden van die testwedstrijd opgeruimd, gevolgd door wedstrijd, verslag, stemmen, aanwezigheid, opstelling, statistieken, gekoppelde testboetes en meldjobs. Andere wedstrijden worden geweigerd. De ontvangst van pushmeldingen op Arthurs toestel is inmiddels door hem bevestigd.
