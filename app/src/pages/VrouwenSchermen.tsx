...
export function VrouwenHome({data,children,stand}:{data:ClubData;children?:ReactNode;stand?:{positie:number;punten:number;gespeeld:number;voor:number}}){
 ...
 <aside className="home-zijde"><div className="club-embleem"><span>SAMEN UIT. SAMEN THUIS.</span><img src={import.meta.env.BASE_URL+'logo-vrouwen-transparant.png'} alt="Steca Vrouwen"/><span>DE DERDE HELFT</span><strong>WIJNTJES DRINKEN.</strong></div>
